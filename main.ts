...
//     */
//    //% block="demo_readData $DHT|Port %port| Read $data" group="3. Sensor."  
...
export function Demo_queryData(DHT: DHTtype, dataPin: DigitalPin, pullUp: boolean, serialOtput: boolean, wait: boolean) {
