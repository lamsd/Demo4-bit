...
namespace Demo4 {
  ...
  /**
    ...
    */
    //% block="Query $DHT|Data pin $demo_DHT11_22Port|Pin pull up $pullUp|Serial output $serialOtput|Wait 2 sec after query $wait" group="1. Declaration."
    //% pullUp.defl=true
    ...
    */
    ...
    // */
    // //% block="Last query successful?" group="3. Sensor."  advanced=true
